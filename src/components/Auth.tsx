...
export function Auth() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-0 right-0 flex flex-col items-center z-50 pointer-events-none">
        <img src={kadoshLogo} alt="Powered by Kadosh AI" className="h-6 opacity-90" />
